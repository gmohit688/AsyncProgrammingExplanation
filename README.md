Firstly it demostrate the synchronous programming. If we will run the solution it will start the task execution and complete all the task one after another
